        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right text-[#d6d9dc] dark:text-[#3f4042] mx-2 text-xs"></i>
                        <span class="text-sm text-[#0c0d0e] dark:text-[#e3e6e8] font-medium">{{$bPlayer->nickname}}</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="lg:col-span-8 space-y-6">
                ...
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row gap-6">
                        <div class="relative flex-shrink-0">
                            <div class="relative">
                                <img src="/project/{{$bPlayer->main_image}}" alt="Player" class="w-32 h-32 rounded-2xl object-cover border-4 border-[#f48024] shadow-lg">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-4 mb-3">
                                <div class="flex-1 min-w-0">
                                    <h1 class="text-2xl sm:text-3xl font-bold text-[#0c0d0e] dark:text-[#e3e6e8] mb-1 truncate">{{ $bPlayer -> nickname}}</h1>
                                    <p class="text-sm sm:text-base text-[#525960] dark:text-[#9fa6ad] mb-3">ID: {{$bPlayer -> id}}</p>
                                    <div class="flex flex-wrap items-center gap-4 text-sm">
                                        <div class="flex items-center gap-1.5">
                                            <i class="fas fa-star text-yellow-500"></i>
                                            <span class="font-bold text-[#0c0d0e] dark:text-[#e3e6e8]">4.9</span>
                                            <span class="text-[#525960] dark:text-[#9fa6ad]">(128 đánh giá)</span>
                                        </div>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                <div class="text-center p-3 rounded-xl bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border border-orange-200 dark:border-orange-800">
                                    ...
                                    <div class="text-xs text-[#525960] dark:text-[#9fa6ad] font-medium">Trận đấu</div>
                                </div>
                                <div class="text-center p-3 rounded-xl bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border border-green-200 dark:border-green-800">
                                    ...
                                    <div class="text-xs text-[#525960] dark:text-[#9fa6ad] font-medium">Tỷ lệ thắng</div>
                                </div>
                                <div class="text-center p-3 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border border-blue-200 dark:border-blue-800">
                                    ...
                                    <div class="text-xs text-[#525960] dark:text-[#9fa6ad] font-medium">Lượt thích</div>
                                </div>
                                <div class="text-center p-3 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border border-purple-200 dark:border-purple-800">
                                    ...
                                    <div class="text-xs text-[#525960] dark:text-[#9fa6ad] font-medium">Hoàn thành</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white dark:bg-[#2d2d2d] rounded-xl border border-[#d6d9dc] dark:border-[#3f4042] p-6 shadow-sm">
                ...
                <ul class="space-y-3 mb-4">
                    <li class="flex items-start gap-3 text-[#525960] dark:text-[#9fa6ad]">
                        ...
                        <span>Chu kỳ nhận: Thứ 2 -> Thứ 7 </span>
                    </li>
                    <li class="flex items-start gap-3 text-[#525960] dark:text-[#9fa6ad]">
                        <div class="flex-shrink-0 w-6 h-6 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center mt-0.5">
                            <i class="fas fa-check text-green-600 dark:text-green-400 text-xs"></i>
                        </div>
                        <span>Thời gian nhận: 00:00 -> 23:59</span>
                    </li>
                    <li class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <span class="text-[#525960] dark:text-[#9fa6ad] block mb-2">Giới thiệu bằng giọng nói:</span>
                            <div class="voice-player-wrapper">
                                <audio class="custom-audio-player" controls>
                                    <source src="/project/{{$bPlayer->voice}}" type="audio/mpeg">
            ...
            <div class="bg-white dark:bg-[#2d2d2d] rounded-xl border border-[#d6d9dc] dark:border-[#3f4042] p-6 shadow-sm">
                ...
                <div id="review-form" class="mb-6 p-5 rounded-xl bg-[#f8f9f9] dark:bg-[#232426] border border-[#e3e6e8] dark:border-[#3f4042] hidden">
                    <h3 class="font-bold text-[#0c0d0e] dark:text-[#e3e6e8] mb-4">Viết đánh giá của bạn</h3>
                    
                    <div class="mb-4">
                        <label class="text-sm font-medium text-[#525960] dark:text-[#9fa6ad] mb-2 block">Đánh giá</label>
                    ...
                    <div class="mb-4">
                        <label class="text-sm font-medium text-[#525960] dark:text-[#9fa6ad] mb-2 block">Nhận xét</label>
                        <textarea rows="4" placeholder="Chia sẻ trải nghiệm của bạn..." class="w-full px-4 py-3 rounded-lg border border-[#d6d9dc] dark:border-[#3f4042] bg-white dark:bg-[#2d2d2d] text-[#0c0d0e] dark:text-[#e3e6e8] focus:outline-none focus:ring-2 focus:ring-[#f48024] resize-none"></textarea>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-6 pb-6 border-b border-[#e3e6e8] dark:border-[#3f4042]">
                    <div class="text-center sm:text-left">
                        ...
                        <div class="text-sm text-[#525960] dark:text-[#9fa6ad]">128 đánh giá</div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="flex-1">
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    <h4 class="font-bold text-[#0c0d0e] dark:text-[#e3e6e8]">Trần Văn B</h4>
                            ...
                            <p class="text-[#525960] dark:text-[#9fa6ad] leading-relaxed mb-3">
                                Player rất nhiệt tình và chuyên nghiệp. Mình đã học được rất nhiều kỹ năng mới và tăng rank nhanh chóng. Chắc chắn sẽ thuê lại!
                            </p>
                ...
                <div class="mt-6 text-center">
                    <button class="px-6 py-3 rounded-lg border-2 border-[#d6d9dc] dark:border-[#3f4042] text-[#525960] dark:text-[#9fa6ad] hover:border-[#f48024] hover:text-[#f48024] transition-all font-medium">
                        Xem thêm đánh giá <i class="fas fa-chevron-down ml-2"></i>
                    </button>
                </div>
            </div>
                ...
                <div class="bg-white dark:bg-[#2d2d2d] rounded-xl border-2 border-[#d6d9dc] dark:border-[#3f4042] p-6 shadow-lg">
                    <div class="mb-6">
                        <div class="flex items-baseline gap-2 mb-2">
                            <span class="text-4xl font-bold text-[#f48024]">{{$bPlayer -> price_per_hour}} <i class="fas fa-gem text-3xl"></i></span>
                            <span class="text-lg text-[#525960] dark:text-[#9fa6ad]">/giờ</span>
                        </div>
                        <p class="text-sm text-[#525960] dark:text-[#9fa6ad]">Giá có thể thay đổi theo thời gian thuê</p>
                    </div>
                    ...
                    <div class="mt-5 pt-5 border-t border-[#e3e6e8] dark:border-[#3f4042] space-y-3">
                        <div class="flex items-center gap-3 text-sm">
                            ...
                            <span class="text-[#525960] dark:text-[#9fa6ad]">Thanh toán được bảo vệ</span>
                        </div>
                        <div class="flex items-center gap-3 text-sm">
                            <div class="w-8 h-8 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center flex-shrink-0">
                                <i class="fas fa-undo text-blue-600 dark:text-blue-400"></i>
                            </div>
                            <span class="text-[#525960] dark:text-[#9fa6ad]">Hoàn tiền nếu player hủy</span>
                        </div>
                        <div class="flex items-center gap-3 text-sm">
                            ...
                            <span class="text-[#525960] dark:text-[#9fa6ad]">Hỗ trợ 24/7</span>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="booking-modal" class="fixed inset-0 z-50 flex items-center justify-center hidden">
    ...
    <div id="booking-modal-content" class="relative bg-white dark:bg-[#2d2d2d] rounded-2xl shadow-xl w-full max-w-lg mx-4 p-6 sm:p-8 modal-content">
        <div class="flex items-start justify-between mb-6">
            <div>
                <h2 class="text-2xl font-bold text-[#0c0d0e] dark:text-[#e3e6e8]">Đặt đơn</h2>
                <p class="text-sm text-[#525960] dark:text-[#9fa6ad]">Điền thông tin để thuê player <span class="font-bold text-[#f48024]">{{$bPlayer->nickname}}</span></p>
            </div>
        ...
        <form action="{{ route('rent') }}" method="POST" id="booking-form-inside-modal">
            <div class="space-y-4">
                <div>
                    <input type="hidden" name="userId" value="<?= $userId ?>" />
                    <input type="hidden" name="bPlayerId" value="{{$bPlayer->id}}">
                    <input type="hidden" name="total_price" id="total-price-input">
                    <label for="hours-input" class="text-sm font-medium text-[#525960] dark:text-[#9fa6ad] mb-2 block">Số giờ thuê</label>
                    <div class="flex items-center">
            ...
            <div class="mt-6 pt-6 border-t border-[#e3e6e8] dark:border-[#3f4042] space-y-2">
                <div class="flex justify-between text-sm">
                    <span class="text-[#525960] dark:text-[#9fa6ad]">Tiền thuê (<span id="hours-display">1</span> giờ)</span>
                    <span id="subtotal" class="font-medium text-[#0c0d0e] dark:text-[#e3e6e8]">0đ</span>
                </div>
                <div class="flex justify-between text-lg font-bold">
                    <span class="text-[#0c0d0e] dark:text-[#e3e6e8]">Tổng cộng</span>
                    <span id="total" name="total" class="text-[#f48024]">0đ</span>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const pricePerHour = parseInt('{{$bPlayer->price_per_hour}}');
