...
<div class="mt-8 max-w-sm mx-auto">
    ...
    <div class="mb-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <a href="/project/bplayer/{{$bPlayer['id']}}" class="player-card bg-white dark:bg-[#2d2d2d] rounded-xl overflow-hidden border border-[#d6d9dc] dark:border-[#3f4042] shadow-sm hover:shadow-lg transition-all cursor-pointer">
                <div class="relative h-64 bg-gradient-to-br from-purple-400 to-pink-400 overflow-hidden">
                    <img src="/project/{{$bPlayer['main_image']}}" alt="Player" class="w-full h-full object-cover">
                ...
                <div class="p-4">
                    <div class="mb-3">
                        <div class="flex items-center justify-between mb-1">
                            <h3 class="font-bold text-[#0c0d0e] dark:text-[#e3e6e8] truncate">{{$bPlayer['nickname']}}</h3>
                            <div class="flex items-center gap-1">
                                <i class="fas fa-star text-yellow-500 text-sm"></i>
                                <span class="text-sm font-semibold text-[#0c0d0e] dark:text-[#e3e6e8]">4.9</span>
                            </div>
                        </div>
                        <p class="text-sm text-[#525960] dark:text-[#9fa6ad]">ID: {{ $bPlayer['id'] }}</p>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-[#e3e6e8] dark:border-[#3f4042]">
                        <div>
                            ...
                            <p class="text-lg font-bold text-[#f48024]">{{ $bPlayer['price_per_hour'] }} <i class="fas fa-gem text-[#f48024]"></i><span class="text-sm font-normal">/h</span></p>
                        </div>
                    </div>
                </div>
                @endforeach
